<template>
  <div class=" min-h-screen z-0 all">
    <Navigation class="z-20"/>
    <router-view class="md:container md:mx-auto md:px-20 xl:px-40 z-10"/>
  </div>
</template>
